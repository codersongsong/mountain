...
/**
 * <Description> 黄河入海流 dubbo服务对象传输Object Value对象 </Description>
 * <ClassName> MountainParametersVo </ClassName>
 *
 * @Author generator
 * @Date 2017年12月13日 11时:57分:38秒
 */
public class MountainParametersVo implements Serializable{
	...
	public MountainParametersVo(){
		map = new HashMap<String , Object>();
	}
	
	public MountainParametersVo(String sources){
		this.sources = sources;
		map = new HashMap<String , Object>();
	}
	
	public MountainParametersVo(String sources , String businessType){
		this.sources = sources;
