...
$.fn.pagination.defaults={total:1,pageSize:20,pageNumber:1,pageList:[10,20,30,40,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_c7,_c8){
},onBeforeRefresh:function(_c9,_ca){
},onRefresh:function(_cb,_cc){
},onChangePageSize:function(_cd){
},beforePageText:"第",afterPageText:"页，共{pages}页",displayMsg:"当前从第（{from}）条到（{to}）条，共（{total}）条数据。",nav:{first:{iconCls:"pagination-first",handler:function(){
...
span.find("input").attr("placeholder",$(_4ba).attr('placeholder'));
if(name){
...
_4d5.attr("placeholder",tb.find(".textbox-value").attr("placeholder"));
_4d5.unbind(".textbox");
if(!opts.disabled&&!opts.readonly){
